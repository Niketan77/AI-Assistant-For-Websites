        ...
        if st.button("Send", key="send_button"):
            if question:
                with st.spinner("Loading..."):
                    ...
                    "If the question is unclear, vague, or unrelated, politely ask for clarification with specific suggestions (e.g., 'Could you specify more in which you are interested?'). "
                    ...
                    "Avoid generic, one-line, or overly verbose answers, balancing brevity with depth, and ensure responses feel like a natural, human-like conversation. "
